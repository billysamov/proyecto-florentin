...
export default function AdminDashboard() {
  ...
  const [config, setConfig] = useState({
    ...
    teacher_badge: "TU PROFESOR",
    mostrar_teacher_badge: true,
    exclusiones_horario: "[]",
    // Sección Video Presentación (Entre Tu Profesor y Por Qué)
    mostrar_seccion_video: true,
    ...
    try {
      ...
      if (configDb) {
        setConfig({
          ...
          teacher_badge: configDb.teacher_badge || "TU PROFESOR",
          mostrar_teacher_badge: configDb.mostrar_teacher_badge !== false,
          mostrar_seccion_video: configDb.mostrar_seccion_video !== false,
  ...
  const guardarConfiguracionCMS = async (e: React.FormEvent) => {
    ...
    const { error } = await supabase
      ...
      .upsert({
        ...
        teacher_badge: config.teacher_badge,
        mostrar_teacher_badge: config.mostrar_teacher_badge,
        mostrar_seccion_video: config.mostrar_seccion_video,
        video_badge: config.video_badge,
        mostrar_video_badge: config.mostrar_video_badge,
        video_titulo: config.video_titulo,
        video_subtitulo: config.video_subtitulo,
        video_url: config.video_url,
        ps_badge: config.ps_badge,
        mostrar_ps_badge: config.mostrar_ps_badge,
